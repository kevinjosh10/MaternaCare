...
const initialParentProfile: ParentProfile = {
  ...
  gravidity: "G1",
  parity: "P0",
  emergencyContactName: "Kevin Joshua",
  emergencyContactRelation: "Spouse",
  emergencyContactPhone: "09884844448",
  preferredFacility: "civil hospital",
  preferredLanguage: "English",
  knownAllergies: "Penicillin (Mild Rash)",
  medicalConditions: "Preeclampsia Risk, Gestational Hypertension (142/92 mmHg), Gestational Diabetes Surveillance, Proteinuria (++), Mild Gestational Anemia (Hb 10.8 g/dL)",
  babyName: "aarav",
};

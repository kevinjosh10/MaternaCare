...
# Map general language codes to gTTS supported codes
GTTS_LANG_MAP = {
    "en": "en", "hi": "hi", "ta": "ta", "te": "te", "bn": "bn", "ml": "ml",
    "mr": "mr", "gu": "gu", "kn": "kn", "pa": "pa", "ur": "ur", "es": "es",
    "fr": "fr", "de": "de", "zh": "zh-CN", "ar": "ar", "ru": "ru", "ja": "ja",
    "pt": "pt", "it": "it", "ko": "ko", "tr": "tr", "nl": "nl", "vi": "vi",
    "pl": "pl", "uk": "uk", "th": "th", "id": "id", "ms": "ms", "tl": "tl",
    "sv": "sv", "da": "da", "fi": "fi", "cs": "cs", "el": "el", "hu": "hu",
    "ro": "ro", "sk": "sk", "bg": "bg", "hr": "hr", "sr": "sr", "sw": "sw"
}
...
class MultilingualTTSModel:
    ...
    Converts clinical model output into authentic human voice in target language.
    """

    def __init__(self, engine_name: str = "Google-Multilingual-TTS"):
    ...
    def synthesize(
        ...
        """
        Synthesizes authentic human speech in the requested language using gTTS.
        """
